...
public class LimboProtocol {
  ...
  public static void init() throws Throwable {
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x27, ProtocolVersion.MINECRAFT_26_3, true)
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x2E, ProtocolVersion.MINECRAFT_26_3, true)
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
    ...
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x63, ProtocolVersion.MINECRAFT_26_3, true)
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x34, ProtocolVersion.MINECRAFT_26_3, true)
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x41, ProtocolVersion.MINECRAFT_26_3, true)
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x49, ProtocolVersion.MINECRAFT_26_3, true)
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x69, ProtocolVersion.MINECRAFT_26_3, true)
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
    ...
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x73, ProtocolVersion.MINECRAFT_26_3, true)
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x60, ProtocolVersion.MINECRAFT_26_3, true)
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x89, ProtocolVersion.MINECRAFT_26_3, true)
    );
